...
const Banner = (props: Props) => {
    return (
        <div className=" bg-orange text-black flex flex-wrap md:flex-nowrap md:flex-1 justify-center xl:gap-40 sm:h-screen">
            <div className="flex flex-col justify-center pt-16 pl-7 xl:pl-40 md:w-1/2">
                ...
                End-to-end UI/UX design services
                </h2>
                ...
                <Button className="md:w-72 w-60 mt-10">Hire UI/UX designers&rarr; </Button>
            </div>
