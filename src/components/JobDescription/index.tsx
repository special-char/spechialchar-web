            ...
            <div className='md:p-20  p-6 bg-background '>
                <div className='flex flex-wrap justify-between max-lg:pb-5 pb-8'>
                    ...
                    <div className='max-lg:py-2'>
                        <Link href={"/company/how-we-work#TableDemo"}>
                            <button className='underline underline-offset-2 text-blue  '>View Jobs</button>
                        </Link>
                    </div>
                </div>
                <hr />
                <div className='py-5 text-subtitle1'>
                    Overview:
                </div>
                <div className='text-subtitle2 xl:pr-96'>
                    {data.Overview}
                </div>
                <div className='py-8 text-subtitle1'>
                ...
                <div className='text-subtitle2 italic xl:pr-96'>
                    {data.Overview1}
                </div>
                <div className='pt-10 '>
                    You can explore more at <Link className=" text-blue" href={"https://thespecialcharacter.com/"}>thespecialcharacter.com</Link>
                </div>
                <div className='pt-3 '>
                    Social Handle: <Link className=" text-blue" href={"https://www.linkedin.com/company/28764000/admin/feed/posts/"}>TheSpecialCharacter</Link>
                </div>
