  ...
  return (
    <section className='bg-black h-full w-full '>
      <Swiper
        ...
        className="  md:h-72 lg:h-80 text-white"
            ...
            <SwiperSlide key={index}>
              <div className='p-1 md:p-4'>
                ...
                <div className='flex gap-x-4 md:gap-x-8 items-center lg:gap-x-10 '>
                  <div>
                    <Image src={slide.src} alt='jef' className='h-16 md:h-24 md:w-24 rounded-full w-16' height={100} width={100}/>
                  </div>
                ...
                <div className='py-4 text-3xl md:py-5 lg:text-4xl'>
                  &quot;{slide.quote}&quot;
                </div>
                </div>
              </div>
