...
const WebIcon = () => {
  return (
    <section className='h-full w-full my-10'>
      <div className='mx-4 grid gap-y-4 md:mx-6 2xl:my-10  2xl:gap-y-6 2xl:mx-0'>
        ...
        <div className='grid gap-y-6 md:grid md:grid-cols-3 md:gap-x-4 '>
          {services.map((service, index) => (
            <div key={index} className='grid gap-y-4 md:gap-y-8  2xl:gap-y-6 md:pt-4'>
        ...
        <div className="pt-2 hover:text-white md:pt-14">
          <button className="bg-blue hover:bg-black hover:text-white text-white text-xl  p-4  font-bold ">
