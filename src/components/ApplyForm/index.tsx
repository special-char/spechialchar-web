    ...
    <section className="bg-gray1 text-primary max-sm:py-16 md:px-20 ">
      <div className="md:p-20  p-6 bg-background ">
        ...
        <Form {...form}>
          ...
          >
            <div className="text-blue text-subtitle2 py-3">
            ...
            <FormItem className="w-full">
              ...
              <div className="py-2">
                <div className="text-blue text-subtitle2 ">
                  Resume{" "}
                  <span className="text-md font-light">
                    (Attach the CV to auto-populate the form!)
                  </span>
                </div>
              ...
              <div>
                ...
                <FormItem className="w-[50%]">
                  ...
                  <FormControl>
                    <Input placeholder="e.g 1039240SDVMN" type="number" />
                  </FormControl>
                  <FormDescription></FormDescription>
                  <FormMessage />
                </FormItem>
              ...
              <div>
                ...
                <p className="italic py-3">
                  We process this data for recruitment purposes (e.g. screening,
                  evaluations, employment letter generations, background
                  verification) only. We also store this data in our applicant
                  tracking system and are fully compliant with the local laws.If
                  you have any questions or concerns, please do not hesitate to
                  contact the recruiter or our reception
                </p>
                <span className="mt-4">
                  <Checkbox /> I Agree
                </span>
