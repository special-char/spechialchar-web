...
const CareerSection2 = ({ data }: CareerSection2Type) => {
    return (
        <div className='flex flex-col md:flex-row gap-10 sm:flex items-center ml-4 md:ml-7'>
            ...
            <div className=" lg:pr-20">
                ...
                <h5 className='text-base sm:text-lg md:text-xl lg:text-xl xl:text-2xl mt-2 md:mt-4 lg:mt-6'>
                ...
                <h5 className='text-base sm:text-lg max-md:text-xl lg:text-xl xl:text-2xl mt-4 md:mt-6'>
