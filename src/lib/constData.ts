...
export const Card1 = {
  cards: [
    ...
    },
    {
      ...
      title: "Metaverse for business leaders: complete guide",
      description:
    ...
    },
    {
      ...
      title: "5 reasons to adopt IoT in sports and fitnes",
      description:
    ...
    {
      id: 7,
      url: "/images/thinking7.webp",
      title: "How much does AI cost in 2024? Well, it depends",
      description:
    ...
    {
      id: 9,
      url: "/images/thinking9.webp",
      title: "AI in the Supply Chain: Use Cases &amp; Implementation Roadmap",
      description:
    ...
    {
      id: 10,
      url: "/images/thinking10.webp",
      title: "How to get started with enterprise automation",
      description:
...
export const carData = [
  {
    src: "/Car-co-uk-preview-1-720x514.webp",
    alt: "Car.co.uk gets hugs boost ",
  },
  {
  ...
  {
    src: "/kobu-agency-7okkFhxrxNw-unsplash-1440x960.webp",
    alt: "Ecommerce platform for affiliate ",
  },
  {
    src: "/e-learning-platform-for-medical-students.webp",
    alt: "E-learning platform for medical radiology ",
  },
  {
    src: "/online-marketing-hIgeoQjS_iE-unsplash-2-1440x810.webp",
    alt: "Web AI application facilitating healthcare  ",
  },
  {
...
export const EdaBanner2 = {
  title: "eLearning software development services",
  description:
    "Make a unique impact online now to grow business with end-to-end custom web development services from ITRex",
  url: "/images/EdBanner.webp",
};
...
export const BgBanner3 = {
  url: "/images/EdBanner4.webp",
