...
const HiringFrequrntlyAskedQuestions = (props: Props) => {
  return (
    <div className="px-container w-full min-h-dvh h-full flex items-center flex-col gap-5 py-4 md:py-10 hiring-section">
      ...
      <div className="flex flex-col gap-2 py-5 mx-auto px-container w-full">
        <Accordion
          type="multiple"
